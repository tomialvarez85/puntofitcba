  ...
  if (isOutOfStock) {
    return (
      <div className="space-y-3">
        <span className="inline-block rounded-lg bg-zinc-100 px-4 py-2 text-sm font-semibold text-zinc-500">
          Sin stock
        </span>
        <button
          type="button"
          disabled
          className="flex w-full cursor-not-allowed items-center justify-center gap-2 rounded-lg bg-zinc-200 px-6 py-3 text-sm font-semibold text-zinc-400 sm:w-auto"
        >
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center rounded-lg border border-zinc-300">
          <button
            ...
            className="flex h-10 w-10 items-center justify-center text-zinc-600 transition disabled:opacity-30"
          >
            <Minus size={16} />
          </button>
