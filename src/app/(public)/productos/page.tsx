...
export default async function ProductsPage({ searchParams }: ProductsPageProps) {
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 sm:py-10">
      ...
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-zinc-900 sm:text-3xl">Catálogo</h1>
        <p className="mt-1 text-sm text-zinc-500">Encontrá el producto ideal para tu entrenamiento.</p>
      </div>
